...
export const ModalMostrarStock = ({ BASE_URL, stockFiltrado, setProductoState, setBusqueda }) => {
    ...
    return (
        <>
            ...
            <div className="bg-[#f5f7f8] py-6">

                <div
                    className="flex items-center rounded-md bg-white shadow shadow-gray-200 w-max mb-5 m-auto"
                >
                    ...
                    <input
                        type="text"
                        className="pl-2 pr-6 py-2 outline-none text-gray-800 placeholder-gray-400 rounded-md"
                ...
                <table
                    className="w-full md:w-[90%] bg-white border m-auto"
                >
                    <thead>
                        <tr className="border-b">
                            <th className="text-start p-2 md:px-7 md:py-5">Cod.</th>
                            <th className="text-start p-2 md:px-7 md:py-5">Nombre</th>
                            <th className="text-start p-2 md:px-7 md:py-5">Cant.</th>
                            <th className="text-start p-2 md:px-7 md:py-5">Pre. Uni.</th>
                            <th className="text-start p-2 md:px-7 md:py-5"></th>
                        </tr>
                    </thead>
